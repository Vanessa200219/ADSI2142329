		...
		<form method="POST" action="editarProceso.php">
			<table class="form__items">
				<tr>
					...
					<td><input type="text" name="txt2Categoria" value="<?php echo $productos1->Codigo_Categoria; ?>"></td>
				</tr>
				<tr>
					<td>Nit Proveedor: </td>
					<td><input type="text" name="txt2Proveedor" value="<?php echo $productos1->Nit_Proveedor; ?>"></td>
				</tr>
				<tr>
					<td>Nombre Producto: </td>
					<td><input type="text" name="txt2Producto" value="<?php echo $productos1->Nombre_Producto; ?>"></td>
				</tr>
				<tr>
					<td>Valor Unitario: </td>
					<td><input type="text" name="txt2Valor" value="<?php echo $productos1->Valor_Unitario; ?>"></td>
				</tr>
				<tr>
					<td>Cantidad: </td>
